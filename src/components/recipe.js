    ...
    return <div className='col-10 mx-auto col-md-6 col-lg-4 my-3'>
      <div className='card' style={{ height: '100%'}} >
        ...
        <div className='card-footer'>
          <Link to={`/recipes/${recipe_id}`} className='btn btn-info text-capitalize'>
            details
          </Link>
          <a href={source_url} target='_blank' rel='noopener noreferrer'     className='btn btn-warning mx-2 text-capitalize'>
            recipe Url
          </a>
        </div>
      </div>
